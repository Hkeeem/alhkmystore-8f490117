...
const supabaseUrl = 'https://pcycuavbjpqvfuwwqlso.supabase.co';
const supabaseAnonKey = 'ضع_هنا_الـ_anon_key_من_Supabase';
...
export async function matchListings(request) {
    let query = supabase
...
export async function handleNewRequest(requestData) {
    try {
