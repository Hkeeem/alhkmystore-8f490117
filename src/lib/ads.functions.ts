...
- اللغة: ${data.dialect === "سعودية" ? "لهجة سعودية طبيعية" : "عربية فصحى معاصرة مبسّطة"}
- النبرة: ${data.tone || "حماسية ومقنعة"}

المطلوب:
- headline: عنوان إعلاني قوي لا يتجاوز 60 حرفاً.
- metaDescription: وصف تسويقي لا يتجاوز 155 حرفاً مناسباً لمحركات البحث.
...
قاعدة لغوية: إذا اختار المستخدم "فصحى"، فاكتب كل النصوص بالعربية الفصحى المعاصرة فقط، دون أي كلمة عامية أو لهجة محلية.`;
