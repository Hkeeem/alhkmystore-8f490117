...
export function InstallHandler() {
  ...
  return (
    <div className="fixed bottom-5 left-1/2 -translate-x-1/2 w-[94%] max-w-md z-50">
      ...
      <div className="relative rounded-3xl bg-[#0a0a0c]/95 backdrop-blur-xl border border-[#D4AF37]/50 shadow-[0_0_40px_rgba(0,0,0,0.8),0_0_25px_rgba(212,175,55,0.2)] overflow-hidden">

        <button
          onClick={dismiss}
          className="absolute top-3 left-3 w-8 h-8 rounded-full flex items-center justify-center bg-[#141416] hover:bg-[#D4AF37]/20 border border-[#D4AF37]/30 transition z-10"
        >
        ...
        <div className="p-5 flex items-center gap-4">
          ...
          <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-[#f6e7a7] via-[#D4AF37] to-[#8f6b10] p-[2px] shrink-0 shadow-[0_0_20px_rgba(212,175,55,0.4)]">
            <img
              src="/164238.jpg"
              alt="Hkeeem AI"
