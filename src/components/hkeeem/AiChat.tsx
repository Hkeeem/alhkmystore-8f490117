...
export default function AiChat() {
  ...
  return (
    <div dir="rtl" className="min-h-screen flex flex-col" style={{ background: "var(--hkeeem-bg)" }}>
        ...
        {messages.map((m, i) =>
          m.isUser ? (
            <div key={i} className="flex justify-start">
              <div className="max-w-[75%] px-4 py-3 rounded-2xl rounded-bl-sm font-semibold text-black"
