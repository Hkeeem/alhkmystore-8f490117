...
const demoCoupons: Coupon[] = [
  ...
  },
  {
    ...
    code: "NOON50",
    title: "خصم 50 ر.س",
    description: "على الإلكترونيات بحد أدنى 300 ر.س",
    discount: "50 ر.س",
    minOrder: 300,
    expiresIn: "أسبوعان",
    category: "خصم عام",
  },
  {
    ...
    code: "SAR40OFF",
    title: "خصم 40 ر.س",
    description: "للطلبات الجديدة على أمازون السعودية",
    discount: "40 ر.س",
    minOrder: 200,
    expiresIn: "10 أيام",
    category: "أول طلب",
  },
  {
    ...
    code: "JARIR10",
    title: "خصم 10%",
    description: "على القرطاسية والكتب فقط",
    discount: "10%",
    expiresIn: "أسبوع",
    category: "خصم عام",
  },
  {
    ...
    code: "EXTRA15",
    title: "خصم 15%",
    description: "على الأجهزة المنزلية الصغيرة",
    discount: "15%",
    minOrder: 500,
    expiresIn: "5 أيام",
    category: "خصم عام",
  },
  {
    ...
    code: "NAHDI20",
    title: "خصم 20%",
    description: "على منتجات العناية الشخصية",
    discount: "20%",
    expiresIn: "أسبوع",
    category: "خصم عام",
  },
  {
    ...
    code: "DAWAA15",
    title: "خصم 15 ر.س",
    description: "على الفيتامينات والمكملات",
    discount: "15 ر.س",
    minOrder: 80,
    expiresIn: "أسبوعان",
    category: "خصم عام",
  ...
  },
  {
    ...
    code: "LULU25",
    title: "خصم 25 ر.س",
    description: "خصم حصري لعملاء وفّر",
    discount: "25 ر.س",
    minOrder: 150,
    expiresIn: "5 أيام",
    category: "حصري",
  },
  {
    ...
    code: "DANUBE12",
    title: "خصم 12%",
    description: "على قسم المخبوزات والأجبان",
    discount: "12%",
    expiresIn: "أسبوع",
    category: "خصم عام",
  },
  {
    ...
    code: "TAM15",
    title: "خصم 15 ر.س",
    description: "على طلبات التميمي أونلاين",
    discount: "15 ر.س",
    minOrder: 100,
    expiresIn: "أسبوعان",
    category: "خصم عام",
