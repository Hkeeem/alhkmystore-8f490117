  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-6 pb-24 md:pb-10" dir="rtl">
      ...
      <p className="text-xs text-muted-foreground">
        عند حفظ مفاتيح واجهة الأفلييت الرسمية تُسحب عروض نون تلقائياً في كل مزامنة وتُدمج مع عروض التجّار في «كل
        العروض». إذا فشلت الواجهة الرسمية يستمر الكتالوج العام كخيار احتياطي دون تعطيل العروض القديمة.
      </p>
    </div>
  );
}
